  ...
  return knex('snap').del()
    .then(function () {
      ...
      return knex('snap').insert([
        ...
        { id: 2, name: 'Milo', image: 'http://placekitten.com/300/200', story: 'I ran into this fluffy friend on my way to the supermarket...', friendliness: 3, lat: -36.87112, lng: 174.763126 },
